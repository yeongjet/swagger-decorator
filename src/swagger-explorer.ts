...
import { flatten, get, head, isArray, isEmpty, mapValues, omit, omitBy, pick } from 'lodash'
import * as pathToRegexp from 'path-to-regexp'
import { DECORATORS } from './constants.js.js.js'
import { exploreApiExcludeControllerMetadata } from './explorers/api-exclude-controller.explorer.js.js.js';
import { exploreApiExcludeEndpointMetadata } from './explorers/api-exclude-endpoint.explorer.js.js.js';
import {
  exploreApiExtraModelsMetadata,
  exploreGlobalApiExtraModelsMetadata
} from './explorers/api-extra-models.explorer.js.js.js';
import { exploreGlobalApiHeaderMetadata } from './explorers/api-headers.explorer.js.js.js';
import { exploreApiOperationMetadata } from './explorers/api-operation.explorer.js.js.js';
import { exploreApiParametersMetadata } from './explorers/api-parameters.explorer.js.js.js';
import {
  exploreApiResponseMetadata,
  exploreGlobalApiResponseMetadata
} from './explorers/api-response.explorer.js.js.js';
import {
  exploreApiSecurityMetadata,
  exploreGlobalApiSecurityMetadata
} from './explorers/api-security.explorer.js.js.js';
import {
  exploreApiTagsMetadata,
  exploreGlobalApiTagsMetadata
} from './explorers/api-use-tags.explorer.js.js.js';
import { DenormalizedDocResolvers } from './interfaces/denormalized-doc-resolvers.interface.js.js.js';
import { DenormalizedDoc } from './interfaces/denormalized-doc.interface.js.js.js';
import {
  OpenAPIObject,
  SchemaObject
} from './interfaces/open-api-spec.interface.js.js.js';
import { MimetypeContentWrapper } from './services/mimetype-content-wrapper.js.js.js';
import { SchemaObjectFactory } from './services/schema-object-factory.js.js.js';
import { isBodyParameter } from './utils/is-body-parameter.util.js.js.js';
import { mergeAndUniq } from './utils/merge-and-uniq.util.js.js.js';
...
export class SwaggerExplorer {
  ...
  public exploreController(wrapper,
